...
public class SkillsController extends BaseController{
    ...
    public JsonResult addResult(@ApiParam(value = "榜单名称", required = true) @RequestParam(name = "name") String name,
                                @ApiParam(value = "维度值", required = true) @RequestParam(name = "dimValue") String dimValue,
                                @ApiParam(value = "用户id", required = true) @RequestParam(name = "userId") long userId,
                                @ApiParam(value = "累计权重", required = true) @RequestParam(name = "weight") long weight){
    ...
    public JsonResult delScore(@ApiParam(value = "榜单名称", required = true) @RequestParam(name = "name") String name,
                               @ApiParam(value = "维度值", required = true) @RequestParam(name = "dimValue") String dimValue,
                               @ApiParam(value = "用户id", required = true) @RequestParam(name = "userId") long userId,
                               @ApiParam(value = "累计权重", required = true) @RequestParam(name = "weight") long weight){
    ...
    public JsonResult list(@ApiParam(value = "榜单名称", required = true) @RequestParam(name = "name") String name,
                           @ApiParam(value = "维度值", required = true) @RequestParam(name = "dimValue") String dimValue,
    ...
    public JsonResult del(@ApiParam(value = "榜单名称", required = true) @RequestParam(name = "name") String name,
                          @ApiParam(value = "维度值", required = true) @RequestParam(name = "dimValue") String dimValue){
    ...
    public JsonResult get(@ApiParam(value = "榜单名称", required = true) @RequestParam(name = "name") String name,
                          @ApiParam(value = "维度值", required = true) @RequestParam(name = "dimValue") String dimValue,
                          @ApiParam(value = "用户id", required = true) @RequestParam(name = "userId") long userId){
    ...
    public JsonResult first(@ApiParam(value = "榜单名称", required = true) @RequestParam(name = "name") String name,
                            @ApiParam(value = "维度值", required = true) @RequestParam(name = "dimValue") String dimValue){
    ...
    public JsonResult rem(@ApiParam(value = "榜单名称", required = true) @RequestParam(name = "name") String name,
                          @ApiParam(value = "维度值", required = true) @RequestParam(name = "dimValue") String dimValue,
                          @ApiParam(value = "用户id", required = true) @RequestParam(name = "userId") long userId){
    ...
    public JsonResult remList(@ApiParam(value = "榜单名称", required = true) @RequestParam(name = "name") String name,
                          @ApiParam(value = "维度值", required = true) @RequestParam(name = "dimValue") String dimValue,
