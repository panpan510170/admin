...
*/
    ...
    var config = {
        ...
        // 默认菜单配置
        menus: ['head', 'bold', 'fontsize','italic', 'underline', 'strikeThrough', 'foreColor', 'backColor', 'link', 'list', 'justify', 'quote', 'emoticon', 'image', 'table', 'video', 'code', 'undo', 'redo'],
...
//构造函数
    function FontSize(editor) {
        ...
        this.editor = editor;
        this.$elem = $('<div class="w-e-menu"><i class="fa fa-font"><i/></div>');
        this.type = 'droplist';
...
// 原型
    UploadVideo.prototype = {
        ...
        uploadVideo: function uploadVideo(files) {
            ...
            var editor = this.editor;
            var config = editor.config;
            var uploadVideoServer = "/upload/uploadImg";//上传地址

            var maxSize = 100 * 1024 * 1024;       //100M
            var maxSizeM = maxSize / 1000 / 1000;
            var maxLength = 1;
            var uploadFileName = "myFileName";
